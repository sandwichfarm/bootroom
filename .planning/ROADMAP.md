...
- [x] 02-02-PLAN.md — /ws axum handler + integration tests incl. COOP/COEP regression (WS-01, WS-04)
...
- [x] 03-06-PLAN.md — watcher.rs (notify-debouncer-full + size-stability + ELF + project_loaded_to_json) + 6 integration tests (CFG-10, WCH-01..05)
- [x] 03-07-PLAN.md — /api/config endpoint + integration tests for shape/order/COOP/CLI overrides/--config default (CFG-01, CFG-09, ACT-01, ACT-03)
